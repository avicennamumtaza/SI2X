            ...
            @foreach ($umkms as $umkm)
                <div class="card">
                    ...
                    <a class="umkm_img_link" href="#" data-toggle="modal" title="Foto UMKM"
                        ...
                        <img src="{{ $umkm->foto_umkm ? env('APP_URL') + '/' + foto_umkm : 'https://img.freepik.com/free-photo/stylish-asian-girl-making-announcement-megaphone-shouting-with-speakerphone-smiling-inviting-people-recruiting-standing-blue-background_1258-89437.jpg?w=900' }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img id="modalImg{{ $umkm->id_umkm }}"
                                        src="{{ $umkm->foto_umkm ? env('APP_URL') + '/' + foto_umkm : 'https://img.freepik.com/free-photo/stylish-asian-girl-making-announcement-megaphone-shouting-with-speakerphone-smiling-inviting-people-recruiting-standing-blue-background_1258-89437.jpg?w=900' }}"
