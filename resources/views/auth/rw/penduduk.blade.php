...
@section('content')
    ...
    <div class="modal fade" id="showPendudukModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal fade" id="importPenduduk" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="exportPenduduk" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
