...
<div id="beranda" class="container-landing">
    <div class="row custom-section justify-content-start">
        <div class="col-12 col-lg-5">
            ...
            <p>Mempersembahkan solusi modern untuk kita bersama memaksimalkan optimalisasi layanan dengan pendekatan yang lebih efisien melalui SIRW sebagai salah satu upaya mendorong kemajuan dan kolaborasi dalam menjawab kebutuhan sehari-hari di lingkungan Rukun Warga.</p>
            ...
            <div class="row">
                <div class="col-md-6"> <!-- Dua kolom di desktop -->
                    <div class="card mb-3">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="{{ asset('assets/landing-pict.png') }}" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
